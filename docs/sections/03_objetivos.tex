...
El objetivo general del presente Trabajo de Fin de Grado es el diseño, implementación y validación de un sistema de monitorización y control de confort térmico para el hogar que opere de forma autónoma en una red local privada, eliminando cualquier dependencia de servicios en la nube para su funcionamiento.
...
\begin{enumerate}
    ...
    \item \textbf{Aislamiento de red:} debe verificarse que ningún paquete de datos del sistema abandone la subred \texttt{192.168.1.0/24} durante su funcionamiento normal.
\end{enumerate}
...
Con los objetivos definidos, el capítulo siguiente examina el estado del arte y las tecnologías disponibles para abordarlos.
