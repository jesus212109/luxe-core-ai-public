...
\begin{frame}{Comparativa de Modelos Evaluados}
  ...
  \begin{columns}[T]
    ...
    \begin{alertblock}{Qwen3.5: descartado}
      \footnotesize
      Modo \textit{thinking} forzado — 0,6--1,2 tok/s en CPU.
...
\begin{frame}{Asesores de Confort Térmico}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Desde fresco ($<$23°C) hasta extremo ($>$34°C)
      \item Evaluación de humedad + tendencia
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Lógica ventana/persiana (temperatura, UV, lluvia)
      \item Detección de presencia + \textbf{\textit{Human in the Loop}}
    \end{itemize}
    ...
    \begin{itemize}
      \item Misma zona térmica $\rightarrow$ no actuar
      \item +1 zona $\rightarrow$ preguntar al usuario
      \item +2 zonas o extrema $\rightarrow$ actuar automático
      \item Sin presencia $\rightarrow$ nunca actuar
    \end{itemize}

    \begin{exampleblock}{Principio}
      \centering\footnotesize
      El sistema sugiere, el usuario decide.\\
      Umbrales claros, sin ambigüedad.
    \end{exampleblock}
  \end{columns}
\end{frame}
