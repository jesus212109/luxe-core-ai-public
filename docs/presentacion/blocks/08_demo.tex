...
% ----------------------------------------------------------------------------
\begin{frame}{7 — Demostración: Test de Integración Completa}
  \hypertarget{s:democontenido}{}
  \begin{columns}[T]
    \column{0.55\textwidth}
    \centering
    \begin{exampleblock}{Panel multimedia}
      \centering
      \IfFileExists{captura_demo.jpg}{%
        \movie[width=0.95\textwidth, height=6.4cm, poster, showcontrols]{%
          \begin{tikzpicture}
            \node[inner sep=0] (img) {\includegraphics[width=0.95\textwidth, height=6.4cm,
              keepaspectratio]{captura_demo.jpg}};
...
% ----------------------------------------------------------------------------
\begin{frame}{7 — Demostración Práctica: Telegram + Dashboard}
  \hypertarget{s:telegram}{}
  \sloppy
  \begin{columns}[T]
    ...
    {\footnotesize Conversación real vía Telegram}
    ...
    {\footnotesize Dashboard web de OpenClaw}
  \end{columns}
